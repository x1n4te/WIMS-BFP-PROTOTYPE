...
for row in ws.iter_rows(min_row=2, values_only=True):
    if row[2]: col_c_vals.add(str(row[2]).strip())

region_codes = {
    'Region_1','Region_2','Region_3','Region_4A','Region_4B','Region_5',
    'Region_6','Region_7','Region_8','Region_9','Region_10','Region_11',
    'Region_12','BARMM','CAR','CARAGA','NCR','NIR'
}
...
KNOWN_SUFFIXES = {
    'a','b','c','g','i','k','l','m','p','q','r','s','t','z',
    'ak','al','an','ba','bo','ca','cn','cs','di','do','es',
    'ii','in','is','lu','mo','mp','nc','ne','nl','no','ns','nv',
    'om','pa','sc','sk','sl','ws','zs',
    'adn','ads','cvp','ddn','dds','ldn','lds','sdn','sds','zdn','zds',
}
...
with open(r'c:/proj/WIMS-BFP-PROTOTYPE/scripts/gen_cities_output.ts', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output_lines) + '\n')
